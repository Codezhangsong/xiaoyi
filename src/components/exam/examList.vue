  ...
  <div>
    ...
    <h5 class="mb-4 row z_flex">
      <div class="col-sm-11 col-xl-11 z_toptitl col-md-10">
        <i class="fas fa-map-marker-alt mr"></i>考试管理 <i class="ion ion-ios-arrow-forward mr ml"></i>
        <span class="c6B78DE">考试管理</span>
        <i class="ion ion-ios-arrow-forward mr ml"></i>
         <span class="c6B78DE">考试管理</span>
      </div>
      <reback></reback>
    </h5>
...
export default {
  ...
  data: () => ({
    ...
    fields: [
      ...
      { key: 'id', label: '编号', sortable: true, tdClass: 'align-middle' },
      { key: 'name', label: '考试名称', sortable: true, tdClass: 'align-middle' },
      { key: 'parent_name', label: '试卷名称', sortable: true, tdClass: 'align-middle' },
      { key: 'parent_mobile', label: '开始时间', sortable: true, tdClass: 'align-middle' },
      { key: 'school', label: '结束时间', sortable: true, tdClass: 'align-middle' },
      { key: 'intention', label: '状态', sortable: true, tdClass: 'align-middle' },
  ...
  created () {
    var that = this
    that.axios.post(`${this.devUrl}exam/examination/show`, that.getParamsToken({
      limit: 999999
    },{
      headers: {
